...
## Журнал изменений
Для того,чтобы посмотреть сделанные изменения в репозитарии, используется команда *git log*. Для этого достаточно выполнить команду *git log* в папке с репозитарием.
